...
#     global wenboChain
#     wenboChain = Chain()
#     print(chainToDict(wenboChain))
#     msg = {'chain' : chainToDict(wenboChain), 'type': 0}
#     json_send = json.dumps(msg)
#     s1.send(json_send)'''
...
def send_out(mutex):
    ...
    # 两次模拟转账
    t1 = Transaction(2, 1, 5)
    t2 = Transaction(2, 3, 16)
    ...
    # 挖矿
    newAddedBlock, fisherRewardTransaction = wenboChain.fishTransactionPool(2, mutex)
    ...
    t3 = Transaction(2, 4, 7)
    sendTransaction(t3, mutex)
